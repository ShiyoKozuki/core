...
-- Dustwallow Marsh
-- Darkmist Cavern
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (6047, 6051, 6058, 6020, 6052, 6053, 6048, 6046, 6006, 6007, 6001));
...
-- Bloodfen Burrow
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (6030, 6011, 6034));
...
-- Den of Flame
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (6004, 6008, 6009, 6010, 6002, 6056, 6054, 6049, 6050, 6055));
...
-- Alterac Mountains
-- Growless Cave
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (5037, 5073, 5050, 5074, 5069, 5022));
...
-- Slaughter Hollow
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (5060, 5047, 5061, 5049, 5013, 5009));
...
-- Crushridge Hold
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (5023, 5043, 5084, 5035, 5083, 5082, 5029, 5081, 5034, 5054, 5028, 5044, 5021, 5004, 5010, 5015, 5014, 5012, 5007, 5019, 5017));
...
-- Excavation Center
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (1755, 1754, 1761, 1762, 1758, 1757, 1759, 5555, 1760, 5556, 5553, 5554));
...
-- Dustbelch Grotto
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (1708, 1706, 1705, 1707, 5508, 5507, 5502, 5501, 5506, 5509, 5503, 5511));
...
-- Misc Cave
UPDATE `gameobject` SET `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` IN (SELECT `guid` FROM `pool_gameobject` WHERE `pool_entry` IN (1747, 1748, 1749));
