...
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = 1
WHERE item IN(7078, 7080, 12803, 7082, 7076, 12808, 19441, 18364, 18361, 18358, 18359, 18362, 18356, 18363, 18360, 18357, 24102, 7997, 1357);
...
WHERE item IN(7068, 7070, 7067, 7069, 10286, 7972, 8150, 7307);
