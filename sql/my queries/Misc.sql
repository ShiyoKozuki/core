...
-- Object Respawn Time
    ...
    UPDATE `mangos`.`gameobject` SET `spawntimesecsmin`=0, `spawntimesecsmax`=0 WHERE id IN (119, 321, 1760, 2084, 28024, 142088);     

-- Object Despawn when looted (data3 = 1 means despawn when looted)
    UPDATE `mangos`.`gameobject_template` SET `data3`=1 WHERE entry IN (119, 321, 1760, 2084, 28024, 142088);
