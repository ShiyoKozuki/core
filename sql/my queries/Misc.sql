...
-- Object Respawn Time
    -- Instant !!!Make sure to also edit the below to despawn when looted
    UPDATE `mangos`.`gameobject` SET `spawntimesecsmin`=0, `spawntimesecsmax`=0 WHERE id IN (2691, 119, 321, 1760, 2084, 28024, 142088);     

-- Object Despawn when looted (data3 = 1 means despawn when looted)
    UPDATE `mangos`.`gameobject_template` SET `data3`=1 WHERE entry IN (2691, 119, 321, 1760, 2084, 28024, 142088);
...
REPLACE INTO `creature` (`guid`, `id`, `id2`, `id3`, `id4`, `id5`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `wander_distance`, `health_percent`, `mana_percent`, `movement_type`, `spawn_flags`, `visibility_mod`, `patch_min`, `patch_max`) VALUES (2000169, 3602, 0, 0, 0, 0, 0, -5616.53, -519.888, 402.836, 1.91507, 25, 25, 0, 100, 100, 0, 0, 0, 0, 10);
REPLACE INTO `creature` (`guid`, `id`, `id2`, `id3`, `id4`, `id5`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `wander_distance`, `health_percent`, `mana_percent`, `movement_type`, `spawn_flags`, `visibility_mod`, `patch_min`, `patch_max`) VALUES (2000171, 3602, 0, 0, 0, 0, 0, -4668.77, -960.825, 500.376, 0.561857, 25, 25, 0, 100, 100, 0, 0, 0, 0, 10);
...
REPLACE INTO `creature` (`guid`, `id`, `id2`, `id3`, `id4`, `id5`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `wander_distance`, `health_percent`, `mana_percent`, `movement_type`, `spawn_flags`, `visibility_mod`, `patch_min`, `patch_max`) VALUES (2000168, 90034, 0, 0, 0, 0, 0, -5623.67, -519.97, 403.541, 2.55202, 25, 25, 0, 100, 100, 0, 0, 0, 0, 10);
REPLACE INTO `creature` (`guid`, `id`, `id2`, `id3`, `id4`, `id5`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `wander_distance`, `health_percent`, `mana_percent`, `movement_type`, `spawn_flags`, `visibility_mod`, `patch_min`, `patch_max`) VALUES (2000170, 90034, 0, 0, 0, 0, 0, -4652.86, -958.754, 500.377, 2.9691, 25, 25, 0, 100, 100, 0, 0, 0, 0, 10);
