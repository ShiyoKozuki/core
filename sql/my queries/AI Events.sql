...
-- Monu
DELETE FROM `creature_ai_scripts` WHERE `id`=2090105;
INSERT INTO `creature_ai_scripts` (`id`, `delay`, `priority`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_param1`, `target_param2`, `target_type`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `condition_id`, `comments`) VALUES
(2090105, 0, 0, 15, 8722, 1, 0, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'Monu - Cast Spell Summon Succubus');

-- Events list for Monu
DELETE FROM `creature_ai_events` WHERE `creature_id`=90046;
INSERT INTO `creature_ai_events` (`id`, `creature_id`, `condition_id`, `event_type`, `event_inverse_phase_mask`, `event_chance`, `event_flags`, `event_param1`, `event_param2`, `event_param3`, `event_param4`, `action1_script`, `action2_script`, `action3_script`, `comment`) VALUES
(9004601, 90046, 0, 1, 0, 100, 0, 1000, 1000, 0, 0, 2090105, 0, 0, 'Monu - Cast Summon Succubus on Spawn');
