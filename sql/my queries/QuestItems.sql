...
WHERE item IN(2607, 2939, 5366, 5233, 3349, 6065, 4612);
...
11837, 12524, 12367, 10552, 18959, 18960, 6245, 5942, 9322, 30046);
...
20377, 10509, 10511, 12334, 6168, 5959, 30045);
...
10551, 11725, 6846, 6844, 3901, 6995, 4435, 4522, 5797, 11467, 5883, 20027, 20023, 6184, 5840, 5841);

-- 45%
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = -45
WHERE item IN(1256, 780, 752, 750, 2671, 2676, 3083, 3084, 3297, 10640, 5170, 1221, 6249, 4527, 4627, 12822, 12444, 1261);

-- 100%
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = -100
WHERE item IN(5796, 5848, 6190, 11503, 11829, 14619, 12738, 13157, 17346, 7267, 6838, 6839, 6840, 6841, 6994);

-- Blackrock Medallion 1-10
UPDATE mangos.creature_loot_template SET maxcount=10 WHERE item = 11467;
