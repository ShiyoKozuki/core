...
11837, 12524, 12367, 10552, 18959, 18960, 6245, 5942, 9322, 30046, 20017, 18622, 18623, 18624, 18604, 9371) AND mincountOrRef = 1;

-- 10%
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = -10
WHERE item IN(5338, 7498, 7499, 7500, 5659, 8973, 18947, 6257, 6258, 6259, 20375, 20374, 
20377, 10509, 10511, 12334, 6168, 5959, 20087, 20613) AND mincountOrRef = 1;

-- 25%
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = -25
WHERE item IN(782, 725, 1256, 6952, 5204, 725, 2536, 2636, 7847, 7846, 
...
10551, 11725, 6846, 6844, 3901, 6995, 4435, 4522, 5797, 11467, 5883, 20027, 20023, 6184, 4495, 4512, 4513, 
6989, 6991, 6844, 11266, 20610, 20611, 9237, 30045, 20614, 3397, 7273, 5412, 5582, 5584, 5386, 5414, 2925, 9460) AND mincountOrRef = 1;

-- 45%
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = -45
WHERE item IN(772, 773, 829, 1256, 780, 752, 750, 2671, 2676, 3083, 3084, 3297, 10640, 5170, 1221, 6249, 4527, 4627, 12822, 12444, 1261, 3496, 3476, 1019, 3110, 5166, 3409, 3411, 3412, 5168, 5884) AND mincountOrRef = 1;

-- 100%
UPDATE mangos . creature_loot_template
SET ChanceOrQuestChance = -100
WHERE item IN(5796, 5848, 6190, 11503, 11829, 14619, 12738, 13157, 17346, 7267, 6838, 6839, 6840, 6841, 6994, 6166, 9591, 18961, 6990, 6930, 15849, 6250, 6251, 6252, 5840, 5841, 17756, 5585, 5583) AND mincountOrRef = 1;
